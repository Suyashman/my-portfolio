    ...
    <section id="contact" className="py-20 relative bg-slate-50/50 dark:bg-transparent">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          >
            <h3 className="text-2xl font-mono mb-6 text-slate-800 dark:text-white uppercase font-bold tracking-widest">Transmit Message</h3>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4 sci-pane p-4 border border-slate-200 dark:border-white/10 group">
                ...
                <div>
                  <h4 className="text-xs font-mono font-semibold text-slate-500 uppercase tracking-widest">Physical_Location</h4>
            ...
            <form onSubmit={handleSubmit} className="sci-pane p-8 border border-slate-200 dark:border-white/10 flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label htmlFor="name" className="text-xs font-mono font-medium text-slate-700 dark:text-slate-300 uppercase tracking-widest">Identifier [Name]</label>
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="email" className="text-xs font-mono font-medium text-slate-700 dark:text-slate-300 uppercase tracking-widest">Return_Address [Email]</label>
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="message" className="text-xs font-mono font-medium text-slate-700 dark:text-slate-300 uppercase tracking-widest">Payload [Message]</label>
